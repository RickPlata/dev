...
public class CuentaNomina implements Transaccionable {
    ...
    public String toString(){
        return "Cuenta Nomina: " + numeroCuenta + " | Titular: " + titular + " | Saldo: " + saldo + " | Tipo: " + tipo;
    }
